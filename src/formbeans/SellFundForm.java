...
public class SellFundForm extends FormBean {
	...
	private void getShareErrors(List<String> errors) {
		...
		if (share.indexOf(".") != -1 && (share.length() - 1 - share.indexOf(".")) > 3) {
		...
		if (shareValue < Constants.MIN_VALUE_OF_SHARE_INPUT || shareValue > Constants.MAX_VALUE_OF_SHARE_INPUT) {
			errors.add("The share should go between " + Constants.MIN_VALUE_OF_SHARE_INPUT + " and "
