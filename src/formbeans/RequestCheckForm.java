...
public class RequestCheckForm extends FormBean {
	...
	private void getAmountErrors(List<String> errors) {
		...
		if (amountValue < Constants.MIN_VALUE_OF_AMOUNT_INPUT || amountValue > Constants.MAX_VALUE_OF_AMOUNT_INPUT) {
			errors.add("The amount should go between " + Constants.MIN_VALUE_OF_AMOUNT_INPUT + " and "
