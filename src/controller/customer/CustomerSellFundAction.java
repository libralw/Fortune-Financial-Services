...
public class CustomerSellFundAction extends Action {
	...
	public String perform(HttpServletRequest request) {
		...
		try {
			...
			Util.i("customerId = ", customer.getId(), ", currentAmount = ", currentAmount, ", validAmount = ",
					validAmount);
			request.setAttribute("currentAmount", Util.formatNumber(currentAmount, Constants.AMOUNT_FORMAT));
			request.setAttribute("validAmount", Util.formatNumber(validAmount, Constants.AMOUNT_FORMAT));
			...
			Util.i("customerId = ", customer.getId(), ", currentAmount = ", currentShare, ", pendingAmount = ",
					pendingShare, ", validAmount = ", validShare);
			request.setAttribute("currentShare", Util.formatNumber(currentShare, Constants.SHARE_FORMAT));
			request.setAttribute("validShare", Util.formatNumber(validShare, Constants.SHARE_FORMAT));
			...
			request.setAttribute("message", Constants.YOUR_TRANSACTION_IS_COMMITED);
