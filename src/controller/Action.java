...
public abstract class Action {
	...
	public void setMaxInputValues(HttpServletRequest request) {
		request.setAttribute("MAX_VALUE_OF_AMOUNT_INPUT_STRING", Constants.MAX_VALUE_OF_AMOUNT_INPUT_STRING);
		request.setAttribute("MAX_VALUE_OF_SHARE_INPUT_STRING", Constants.MAX_VALUE_OF_SHARE_INPUT_STRING);
		request.setAttribute("MAX_VALUE_OF_PRICE_INPUT_STRING", Constants.MAX_VALUE_OF_PRICE_INPUT_STRING);
	}
}
