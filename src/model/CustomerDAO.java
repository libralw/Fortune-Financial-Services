...
public class CustomerDAO extends GenericDAO<Customer> {
	...
	public Customer[] find(String keyword) throws RollbackException {
		Customer[] users = match(MatchArg.or(MatchArg.containsIgnoreCase("userName", keyword),
				MatchArg.containsIgnoreCase("firstName", keyword), MatchArg.containsIgnoreCase("lastName", keyword)));
		return users;
	}
