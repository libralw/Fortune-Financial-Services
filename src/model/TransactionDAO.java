...
public class TransactionDAO extends GenericDAO<TransactionBean> {
	...
	public double getPendingShare(int customerId, int fundId) throws RollbackException {
		TransactionBean[] transactions = match(
				MatchArg.and(MatchArg.equals("customerId", customerId), MatchArg.equals("fundId", fundId),
						MatchArg.equals("date", 0L), MatchArg.equals("type", TransactionBean.SELL_FUND)));
		long share = 0;
	...
	public double getPendingAmount(int customerId) throws RollbackException {
		TransactionBean[] transactions = match(
				MatchArg.and(MatchArg.equals("customerId", customerId), MatchArg.equals("date", 0L)));
		long amount = 0;
		if (transactions == null) {
			return amount;
		}
	...
	public TransactionBean getLastTransaction(int customerId) throws RollbackException {
		TransactionBean[] transactions = match(
				MatchArg.and(MatchArg.equals("customerId", customerId), MatchArg.max("date")));
