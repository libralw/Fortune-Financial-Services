...
public class Constants {
	...
	public static final String MAX_VALUE_OF_AMOUNT_INPUT_STRING = Util.formatNumber(MAX_VALUE_OF_AMOUNT_INPUT,
			AMOUNT_FORMAT);
	...
	public static final String MAX_VALUE_OF_PRICE_INPUT_STRING = Util.formatNumber(MAX_VALUE_OF_PRICE_INPUT,
			PRICE_FORMAT);
	...
	public static final String MAX_VALUE_OF_SHARE_INPUT_STRING = Util.formatNumber(MAX_VALUE_OF_SHARE_INPUT,
			SHARE_FORMAT);
