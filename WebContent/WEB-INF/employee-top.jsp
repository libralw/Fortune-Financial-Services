									...
									<ul class="nav navbar-nav">
										<li class="btn-group navbar-btn">
											...
											<ul class="dropdown-menu" role="menu">
												<li><a href="employee_register.do">Create Employee
														Account</a></li>
												<li><a href="employee-change-pwd.do">Change Your
														password</a></li>
											</ul>
										</li>
										<li>&nbsp;</li>
										<li class="btn-group navbar-btn">
											...
											<ul class="dropdown-menu" role="menu">
												<li><a href="employee_create_customer.do">Create
														Customer Account</a></li>
												<li><a href="employee_search_customer.do">View
														Customer Account</a></li>
											</ul>
										</li>
										<li>&nbsp;</li>
										<li class="btn-group navbar-btn">
											...
											<ul class="dropdown-menu" role="menu">
												...
												<li><a href="employee-transition-day.do">Transition
														Day</a></li>
											</ul>
										</li>
									</ul>
