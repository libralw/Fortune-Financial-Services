		...
		<div class="col-sm-10">
			...
			<form role="form">
				...
				<div class="col-sm-offset-2">
					<p style="color: grey">*Please enter a number with no more than
						2 digits after the decimal</p>
					<p style="color: grey">*Range between 0.01 and
						${MAX_VALUE_OF_AMOUNT_INPUT_STRING}
					<p>
				</div>
