						...
						<nav class="navbar navbar-default">
							<div class="container-fluid">
								...
								<div class="navbar-header">
									...
									<a class="navbar-brand" href="customer_viewaccount.do">My
										Account</a>
								</div>
									...
									<ul class="nav navbar-nav">
										<li class="btn-group navbar-btn">
											...
											<ul class="dropdown-menu" role="menu">
												<li><a href="customer_viewaccount.do">View Account
														Info</a></li>
												<li><a href="customer-change-pwd.do">Change
														Password</a></li>
										...
										<li class="btn-group navbar-btn">
											...
											<ul class="dropdown-menu" role="menu">
												<li><a href="customer-request-check.do">Request
														Check</a></li>
												<li><a href="customer-view-transactions.do">Transaction
														History</a></li>
